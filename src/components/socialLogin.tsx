...
const SocialLogin = () => {
  ...
  return (
    <>
      <p className="text-center text-black font-base my-[5px] mx-0">Or With</p>

      <div className="flex flex-row items-center justify-between gap-[10px]">
        <button
          onClick={handleGoogleLogin}
          className="btn mt-[10px] w-full h-[50px] rounded-md hover:border-[#947764] flex justify-center items-center font-bold gap-[10px] border border-[#ededef] bg-white cursor-pointer duration-300"
        >
          <svg
            version="1.1"
            width="20"
          ...
          >
            ...
            <path
              fill="#518ef8"
              d="M507.527,208.176C510.467,223.662,512,239.655,512,256c0,18.328-1.927,36.206-5.598,53.451-12.462,58.683-45.025,109.925-90.134,146.187l-0.014-0.014l-73.044-3.727l-10.338-64.535c29.932-17.554,53.324-45.025,65.646-77.911h-136.89V208.176h138.887L507.527,208.176L507.527,208.176z"
            />
            <path
              fill="#28b446"
